...
export default function EditSubscriptionPage({ params }: { params: { id: string } }) {
  ...
  const onSubmit = async (data: SubscriptionFormValues) => {
    ...
    try {
      ...
      console.log("Güncellenecek veri:", formattedData);
      ...
      toast.error("Abonelik güncellenirken bir hata oluştu. Lütfen tekrar deneyin.");
    } finally {
      setIsSaving(false);
    }
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">Abonelik Düzenle</h1>
